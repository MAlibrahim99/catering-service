...
|_Cateringservice_ _Mampf_    | 5 | -Auftraggeber | -automatisieren -mehr verkaufen/höhere Effizienz -übersichtlicher
|Kunden (Firmen, Privatkunden) | 4 | -Hauptnutzer, sollen Geld einbringen | -übersichtlich, -schnelles/einfaches buchen von Events
|Administrator(en) Herr Wurst | 2 | -kann alle Bestellungen und Termine sehen | -Einsicht in gesamtes System -Verwaltet alles
|Entwickler | 3 | -implementiert das System, Wartung, Erweiterungen | -geringer wartungsaufwand -einfach erweiterbar
