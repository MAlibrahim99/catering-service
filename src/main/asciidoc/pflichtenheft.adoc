...
image:gui/anmelden.png[Anmeldeseite des Cateringservice, title= "Anmeldeseite des Cateringservice", align=center]
...
*Bemerkung*: Nummerierung AT : 2 Ziffern von UC : 1 Ziffer Unternummern des Tests für einen UC
