...
public class CatalogInitializer implements DataInitializer {
	...
	public void initialize() {
		...
		catalog.save(new Option("Servietten", Money.of(0.2, EURO), OptionType.GOODS, new String[] {"Eventcatering", "Partyservice", "Mobile Breakfast"}));

		catalog.save(new Option("Dekoration", Money.of(3, EURO), OptionType.EQUIP, new String[] {"Eventcatering"}));
		catalog.save(new Option("Geschirr", Money.of(5, EURO), OptionType.EQUIP, new String[] {"Eventcatering", "Partyservice", "Mobile Breakfast"}));
		...
		catalog.save(new Option("Frühstück", Money.of(10, EURO), OptionType.FOOD, new String[] {"Mobile Breakfast"}));
	}
}
