image:https://github.com/st-tu-dresden-praktikum/swt21w27/workflows/CI%20build/badge.svg["CI Build", link="https://github.com/st-tu-dresden-praktikum/swt21w27/actions"]
...
The catering module is a template project to bootstrap the Java project in the Software Engineering lab.
